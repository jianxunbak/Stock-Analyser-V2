...
const MoatCard = ({ onMoatStatusChange, onIsEvaluatingChange, currency = 'USD', currencySymbol = '$', currentRate = 1, isOpen = true, onToggle = null }) => {
    ...
    return (
        <div ref={cardRef} className={styles.card}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: isOpen ? '1rem' : '0' }}>
                <h3 className={styles.title} style={{ margin: 0 }}>Economic Moat</h3>
